package parser.lexical.tokenizer;

import parser.lexical.TokenizerException;
import parser.lexical.type.Word;
...
public class Tokenizer {
    ...
    static {
        ...
        keywords.put(Type.Matrix4.getLexeme(), Type.Matrix4);
        ...
        keywords.put(Word.loop.getLexeme(), Word.loop);
        keywords.put(Word._do.getLexeme(), Word._do);
//        keywords.put(Word.arrayLength.getLexeme(), Word.arrayLength);
//        keywords.put(Word.matrixLength.getLexeme(), Word.matrixLength);
//        keywords.put(Word.sin.getLexeme(), Word.sin);
//        keywords.put(Word.cos.getLexeme(), Word.cos);
//        keywords.put(Word.tan.getLexeme(), Word.tan);
//        keywords.put(Word.ctg.getLexeme(), Word.ctg);
    ...
    private void extractNextToken() {
        ...
        if (Character.isDigit(data[curPos])) {
            int v = 0;
            do {
                v = v * 10 + Character.digit(data[curPos], 10);
                curPos++;
            ...
            for (; ; ) {
                ...
                x = x + Character.digit(data[curPos], 10) / d;
                d *= 10;
            }
